...
public final class PersonWarehouse implements Iterable<Person> {
    ...
    public Stream<Person> getUniquelyNamedPeople() {
            Collection<Person> map = people.stream()
                    .collect(Collectors.toMap(Person::getName, p -> p, (p, q) -> p,LinkedHashMap::new)).values();
        return map.stream();
    }
    /**
    ...
    public Stream<Person> getFirstNUniquelyNamedPeople(int n) {
        ...
        return getUniquelyNamedPeople().distinct().limit(n);
    }
    ...
    Map<Long, String> map = people.stream().collect(Collectors.toMap(Person::getPersonalId, Person::getName));
    return map;
    }
